...
public class PaodingAnalyzer extends PaodingAnalyzerBean {
	 ...
	 * @deprecated
	 */
	public static net.paoding.analysis.analyzer.PaodingAnalyzer queryMode(Knife knife) {
	 ...
	 * @deprecated
	 */
	public static net.paoding.analysis.analyzer.PaodingAnalyzer defaultMode(Knife knife) {
		return new net.paoding.analysis.analyzer.PaodingAnalyzer(knife, MOST_WORDS_MODE);
	}
	 ...
	 * @deprecated
	 */
	public static net.paoding.analysis.analyzer.PaodingAnalyzer maxMode(Knife knife) {
		return new net.paoding.analysis.analyzer.PaodingAnalyzer(knife, MAX_WORD_LENGTH_MODE);
	}
	 ...
	 * 
	 */
	public static net.paoding.analysis.analyzer.PaodingAnalyzer writerMode(Knife knife) {
