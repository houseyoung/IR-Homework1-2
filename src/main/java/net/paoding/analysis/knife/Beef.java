...
/**
 * {@link net.paoding.analysis.knife.Beef}是要被庖丁“解”的“牛骨肉”，是对文本字符流的高效封装，可以从中读取指定位置的字符。
 * <p>
 * {@link net.paoding.analysis.knife.Beef}和{@link String}对象的不同之处在于：<br>
 * {@link net.paoding.analysis.knife.Beef}共享输入的char数组，{@link String}的策略是对共享数组进行克隆，克隆损耗了性能。<br>
 * 同时，{@link net.paoding.analysis.knife.Beef}在 {@link #charAt(int)}方法还进行对字符的预处理，使返回时符合规则:1)toLowerCase
 * 2)全角转半角等
 * <p>
 * 
