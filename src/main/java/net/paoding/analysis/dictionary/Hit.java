...
public class Hit {
	...
	public final static net.paoding.analysis.dictionary.Hit UNDEFINED = new net.paoding.analysis.dictionary.Hit(UNDEFINED_INDEX, null, null);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final net.paoding.analysis.dictionary.Hit other = (net.paoding.analysis.dictionary.Hit) obj;
		if (word == null) {
			if (other.word != null)
				return false;
