...
public class HashBinaryDictionary implements Dictionary {
	 ...
	 */
	private net.paoding.analysis.dictionary.Word[] ascWords;
	 ...
	 * @param loadFactor
	 */
	public HashBinaryDictionary(net.paoding.analysis.dictionary.Word[] ascWords, int initialCapacity,
								float loadFactor) {
		this(ascWords, 0, 0, ascWords.length, initialCapacity, loadFactor);
	}

	public HashBinaryDictionary(net.paoding.analysis.dictionary.Word[] ascWords, int hashIndex, int start,
	...
	protected Dictionary createSubDictionary(net.paoding.analysis.dictionary.Word[] ascWords, int beginIndex,
											 int endIndex) {
		int count = endIndex - beginIndex;
		if (count < 16) {
			return new BinaryDictionary(ascWords, beginIndex, endIndex);
		} else {
			return new net.paoding.analysis.dictionary.HashBinaryDictionary(ascWords, hashIndex + 1,
	...
	public net.paoding.analysis.dictionary.Word get(int index) {
