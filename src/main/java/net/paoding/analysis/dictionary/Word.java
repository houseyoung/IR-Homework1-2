...
public class Word implements Comparable<net.paoding.analysis.dictionary.Word>, CharSequence {
	...
	public int compareTo(net.paoding.analysis.dictionary.Word obj) {
	...
	public boolean startsWith(net.paoding.analysis.dictionary.Word word) {
	...
	public boolean equals(Object obj) {
		return text.equals(((net.paoding.analysis.dictionary.Word) obj).text);
	}
	...
	public static void main(String[] args) {
		net.paoding.analysis.dictionary.Word w = new net.paoding.analysis.dictionary.Word("");
