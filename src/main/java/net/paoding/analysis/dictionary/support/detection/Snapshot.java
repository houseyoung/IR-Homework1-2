...
public class Snapshot {
	...
	public static net.paoding.analysis.dictionary.support.detection.Snapshot flash(String root, FileFilter filter) {
		return flash(new File(root), filter);
	}
	
	public static net.paoding.analysis.dictionary.support.detection.Snapshot flash(File rootFile, FileFilter filter) {
		net.paoding.analysis.dictionary.support.detection.Snapshot snapshot = new net.paoding.analysis.dictionary.support.detection.Snapshot();
	...
	public net.paoding.analysis.dictionary.support.detection.Difference diff(net.paoding.analysis.dictionary.support.detection.Snapshot that) {
		net.paoding.analysis.dictionary.support.detection.Snapshot older = that;
		net.paoding.analysis.dictionary.support.detection.Snapshot younger = this;
		if (that.version > this.version) {
			older = this;
			younger = that;
		}
		net.paoding.analysis.dictionary.support.detection.Difference diff = new net.paoding.analysis.dictionary.support.detection.Difference();
	...
	public static void main(String[] args) throws InterruptedException {
		File f = new File("dic");
		net.paoding.analysis.dictionary.support.detection.Snapshot snapshot1 = flash(f, null);
		System.out.println("----");
		Thread.sleep(3000);
		System.out.println("----");
		Thread.sleep(3000);
		System.out.println("----");
		net.paoding.analysis.dictionary.support.detection.Snapshot snapshot2 = flash(f, null);
