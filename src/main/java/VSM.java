...
public class VSM {
     ...
     * @throws Exception
     */
    public static Map documentVector(Map<String, Double> queryMap, List<TF> tfList, int docNumber) throws Exception {
        //将queryMap中所有的value都置为0，存入termMap
        Map<String, Double> termMap = new LinkedHashMap<String, Double>();
